...
const Calculator = {
    ...
    //This will hold the operator, we set it to null now
    operator: null,
};
...
function Input_Digit(digit) {
    ...
    //We are checking to see if Wait_Second_Operand ia true and set
...
//This seciom handles decimal points
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        //in hte Perform_Calculation object and the function that matches the
